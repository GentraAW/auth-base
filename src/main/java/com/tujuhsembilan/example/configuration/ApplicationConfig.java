...
public class ApplicationConfig {
  ...
  public SecurityFilterChain securityConfig(HttpSecurity http, PasswordEncoder passwordEncoder, AuthProp prop)
    ...
    http
        ...
        .authorizeHttpRequests(req -> req
            ...
            .requestMatchers(new AntPathRequestMatcher("/admin/do-something")).hasAnyAuthority("SYSTEM", "ADMIN")
  ...
  public JwtAuthenticationConverter jwtAuthenticationConverter() {
    ...
    grantedAuthoritiesConverter.setAuthoritiesClaimName("authorities"); // Use "authorities" if this is the claim name
                                                                        // used in JWT
